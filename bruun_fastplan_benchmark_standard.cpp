...
static void bench_one(int N, int forced_iters, FFTW* fftw, std::mt19937_64& rng) {
    ...
    std::printf("%11.1f %11.1f %8.3f %8.3f  err %.1e rt %.1e sink %.8g\n",
                bruun_native_ns, bruun_standard_ns, native_ratio, standard_ratio,
                fwd_err, rt_err, sink);
...
int main(int argc, char** argv) {
    ...
    std::printf("%8s %8s %11s %11s %11s %8s %8s  %s\n",
